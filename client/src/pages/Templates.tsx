    ...
    <div className="space-y-4">
      <div>
        ...
        <p className="text-sm text-muted-foreground">
          Etiket, kılavuz, ambalaj, renk ve kategori gibi tekrar kullanılan metinleri bir kez
          tanımla — ürünlere ve türetmeye tek tıkla eklensin. Seri ayarları Ürünler &gt; Seri
          kurgusu sekmesinde.
        </p>
      </div>
